...
broodstock <-
  ...
  mutate(JACK_BROODSTOCK_REMOVALS = ifelse(is.na(JACK_BROODSTOCK_REMOVALS), 0, JACK_BROODSTOCK_REMOVALS)) |>
  mutate(OTHER_REMOVALS = ifelse(is.na(OTHER_REMOVALS), 0, OTHER_REMOVALS))
